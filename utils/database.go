...
func ConnectToBase() *mongo.Client {
	newMongoInstance, err := mongo.Connect(context.TODO(), options.Client().ApplyURI("mongodb+srv://"+url.QueryEscape("PametniPaketnik")+":"+url.QueryEscape("PametniPaketnik")+"@cluster0.ioplwkz.mongodb.net/?retryWrites=true&w=majority"))
	if err != nil {
